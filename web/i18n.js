...
const ZH = {
  ...
  // AI 生成内容标识（《人工智能生成合成内容标识办法》要求的界面提示）
  'AI generated': 'AI 生成',
  'AI LABELED': '已标识',
  'This image was generated by AI.': '本图片由人工智能生成合成。',
  'This image was generated by AI. The file carries an AI content label.': '本图片由人工智能生成合成，文件中已添加 AI 生成内容标识。',
  'Results are AI-generated: each one carries a visible “AI generated” mark and an AI content label in its file metadata, as required by Chinese law.': '生成结果由人工智能生成合成：按《人工智能生成合成内容标识办法》，每张作品都带有可见的「AI 生成」标识，文件元数据中也写入了生成合成标识。',
  'Compare': '对比',
  'STANDARD': '标准',
  'PRIVATE': '私密',
  'Saved ✓': '已保存 ✓',
  ...
  // QQ group
  'Group number copied': '群号已复制',
  'QQ group QR code': 'QQ 群二维码',
  'QQ group · fastest': 'QQ 群 · 最快',
  'Join the group and message the admin to buy — credited within minutes during the day.': '加群后私聊群主购买，白天通常几分钟内到账。',
  'Copy group number': '复制群号',
  'QR code': '二维码',
  'Or email us': '或发邮件',
  'Premium directions come with Creator. Pick the plan below, then join our QQ group or email us — we enable it on your account.': 'Premium 风格包含在 Creator 里。选好下面的套餐，加 QQ 群或发邮件联系我们，我们为你的账号开通。',
  'You have {n} left. Packs below add more — buy in our QQ group or by email and we credit your account.': '你还剩 {n} 张。下面的点数包可以加更多——在 QQ 群或邮件购买，我们为你的账号充值。',
  'You have used the {n} free artworks that come with your account. Pick a pack below, then join our QQ group or email us — we credit your account by hand.': '账号附带的 {n} 张免费作品已经用完。选一个点数包，加 QQ 群或发邮件联系我们，我们人工为你充值。',
  'QQ / email to buy': 'QQ 群 / 邮件购买',
  'QQ group ': 'QQ 群 ',
  'QQ group · buy credits': 'QQ 群 · 购买额度',
  ...
  // price list v2 (2026-09-23)
  'Currency': '币种',
  'Try 3 first': '先试 3 张',
  'One per account': '每个账号限购一次',
  'Best value': '最划算',
  '30 days': '30 天',
  '{n} artworks + Premium + high-res · one-time, no auto-renewal': '{n} 张 + Premium + 高清 · 一次性、不自动续费',
  '≈ {price}/mo · save {pct}%': '相当于 {price}/月 · 省 {pct}%',
  'The trial pack can only be bought once per account': '体验包每个账号只能买一次',
  'All directions unlocked · pass valid until {date}': '全部风格已解锁 · 通行证有效期至 {date}',
  'Premium directions come with Creator. Get the 30-day pass below — pay by WeChat, unlocked as soon as the payment is confirmed.': '付费风格随 Creator 解锁。在下方购买 30 天 Creator 通行证、微信支付，付款确认后立即开通。',
  ...
  'Payments are being activated — please try again later': '支付通道正在审核中，请稍后再试',
  'Opening…': '正在打开…',
  'Account': '账户',
  'Buy credits': '购买额度',
  'QQ group · help': 'QQ 群 · 咨询',
  'Questions, or prefer to pay another way? Join the group and message the admin.': '有疑问或想换种方式付款？加群私聊群主。',
